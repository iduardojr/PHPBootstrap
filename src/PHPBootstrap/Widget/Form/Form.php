...
class Form extends AbstractContainer {
	...
	/**
	 * Adiciona um bot�o ao formalario
	 *
	 * @param Btn $button
	 * @return boolean
	 */
	...
	/**
	 * Dispara um evento e retorna se deve seguir ou n�o com o padr�o do evento: 
	 * - Form.Validate
	 * - Form.ChangeValue
	 *
	 * @param string $event
