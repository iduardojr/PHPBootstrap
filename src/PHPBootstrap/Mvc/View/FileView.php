 ...
 */
class FileView implements Viewable {
	 ...
	 */
	public function __construct( $fileName, $forceDownload = true, $aliasName = null ) {
		$this->setFileName($fileName);
		$this->setForceDownload($forceDownload, $aliasName);
	}
	...
	/**
	 * Obtem o apelido de download do arquivo
	 *
	 * @return string
	 */
	...
	/**
	 * Atribui o apelido de download do arquivo
	 *
	 * @param string $aliasName
	 */
	...
	/**
	 * Obtem se deve for�ar o download
	 *
	 * @return boolean
	 */
	 ...
	 * @param string $aliasName
	 */
	public function setForceDownload( $force, $aliasName = null ) {
		$this->forceDownload = ( bool ) $force;
		$this->aliasName = $aliasName;
	}
